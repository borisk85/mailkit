...
0. **Баг** — чинить сразу, без команды. **Варианты A/B/C** — предложить, замолчать, ждать команды. Реализовывать только после явного «сделай A» / «давай B» / «A» от Boris. Никогда не выбирать самому и не начинать до команды.
   **Вопрос от Boris ≠ команда.** «как было раньше?», «почему так?», «что думаешь?» — отвечать словами, не лезть в код. Действие только на императив: «сделай», «правь», «давай», «ок».
