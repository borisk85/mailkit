...
- Аутентификацию домена-отправителя в Postmark SMTP (DKIM, SPF, DMARC
  записи)
...
- Автоматический полный возврат в течение 24 часов если наша
  автоматическая настройка (фазы Cloudflare или Postmark) не завершилась
  по нашей вине
...
- Непрерывная доступность сторонних сервисов (Cloudflare, Postmark,
...
- Защита от приостановки со стороны Postmark или другого стороннего
...
- Вы не будете использовать сервис для отправки спама, фишинга,
  ...
  или антиспамовые политики Cloudflare, Postmark и Google
- Вы понимаете что чрезмерный процент отказов, жалобы на спам или
  ...
  инфраструктуры Postmark обеспечивающей работу сервиса
...
- Ваши SMTP-реквизиты для Postmark (server token) предоставляются
  Postmark и отображаются вам во время мастера настройки
