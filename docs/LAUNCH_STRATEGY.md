...
5. **Промокод FIRST100** — упоминается во всех публикациях как
   attention-hook. Первые 100 платежей за $0 в обмен на отзыв.
...
4. **100 бесплатных по FIRST100** = bait для day-of conversion.
...
- Week 1: 30-50 платящих + 50-100 бесплатных по FIRST100
