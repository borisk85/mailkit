...
> Cloudflare Email Routing or Brevo SMTP fails to complete for your domain
...
> автоматическая настройка Cloudflare Email Routing или Brevo SMTP не
...
- EN: "Email on your domain in 5 minutes. [Guaranteed*](/guarantee)"
- RU: "Почта на домене за 5 минут. [С гарантией*](/guarantee)"
...
- EN headline: "Email on your domain in 5 minutes."
- EN trust badge под headline: "30-day money-back guarantee — details"
- RU headline: "Почта на домене за 5 минут."
