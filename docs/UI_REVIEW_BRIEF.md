...
- Контент: иконка `Sparkle` (lucide-react) `size 14, opacity 0.7` + текст "Launch week — first 100 setups free with promo FIRST25" + ссылка "See how →" (underline on hover)
- Dismiss крестик: `size 14 / opacity 0.5 / hover opacity 1`
- Border-bottom: `1px solid border-subtle`

**RU копи:** "Launch week — первые 100 настроек бесплатно по промокоду FIRST25"
